...
import {
  DeleteRestaurantParam,
  RestaurantQueryStringId,
  createRestaurantBody,
} from "./restaurant-schema.consts"
import {
  CreateRestaurant,
  DeleteRestaurantParamInterface,
  GetRestaurantParamInterface,
  UpdateRestaurantBodyInterface,
...
export const RestaurantRoutes = async (app: FastifyInstance) => {
  ...
  app.post(
    ...
    { schema },
    async (
      request: FastifyRequest<{ Body: CreateRestaurant }>,
  ...
  app.get(
    ...
    { schema },
    async (
      request: FastifyRequest<{ Querystring: GetRestaurantParamInterface }>,
      response: FastifyReply,
    ) => {
  ...
  app.put(
    ...
    async (
      request: FastifyRequest<{
        ...
        Querystring: GetRestaurantParamInterface
      }>,
      response: FastifyReply,
    ) => {
  ...
  app.delete(
    "/restaurant/:id",
    { schema: { params: DeleteRestaurantParam } },
    async (
      request: FastifyRequest<{ Params: DeleteRestaurantParamInterface }>,
      response: FastifyReply,
    ) => {
